  ...
  return (
    <NavContent>
        ...
        <Feature>
            ...
            <FeatureItem>
                <a href="#">
                    <Icon><ion-icon name="library-outline"></ion-icon></Icon>
                    Library
                </a>
            </FeatureItem>
        </Feature>
        ...
        <Function>
            <Feature>
                ...
                <FeatureItem>
                    <a href="#">
                        <Icon><ion-icon name="heart-outline"></ion-icon></Icon>
                        Liked Songs
                    </a>
                </FeatureItem>
